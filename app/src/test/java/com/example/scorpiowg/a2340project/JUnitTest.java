...
public class JUnitTest {
    ...
    public void testLoginUser() {
        ...
        User curUser = new ShelterEmployee("test", "testid", "test", "1");
    ...
    public void testRegisterUser() {
        ...
        userDatabase.put("testid", curUser);
        //confirmed and exist
        assertFalse(Model.getInstance().registerUser(userDatabase, "testid", "test", "test", "test"));
        //not confirmed and exist
        assertFalse(Model.getInstance().registerUser(userDatabase, "testid", "test", "wrongconfirm", "test"));
        //not confirmed and not exist
        assertFalse(Model.getInstance().registerUser(userDatabase, "newUser", "test", "wrongconfirm", "newname"));
        //confirmed and not exist
        assertTrue(Model.getInstance().registerUser(userDatabase, "newUser", "new", "new", "newname"));
    }
